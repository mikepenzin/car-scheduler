...
$(document).ready(function() {
    ...
    function appendCar(car) {
        ...
        var disableMessage = '';
        if (car.isActive) {
            carActive = '<div id="not-active-' + car._id + '" class="text-warning no-driver-message mt-2 d-none d-sm-block" style="visibility: hidden;">';
            ...
            carActive = '<div id="not-active-' + car._id + '" class="text-warning no-driver-message mt-2 d-block">';
        ...
        var carTemplate = $('<div id="general_' + car._id + '" class="col-12 col-sm-10 col-md-6 col-lg-6 col-xl-6">' +
            '<div class="card">' +
            '<div class="card-info">' +
